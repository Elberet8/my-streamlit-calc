...
BREED_NORMS = {
    "Собаки": {
        ...
        "Йоркширский терьер": {"value": 9.9, "sd": 0.6},
        "Кавалер кинг чарльз спаниель": {"value": 10.6, "sd": 0.5},
        "Карликовый пинчер": {"range": (9.6, 12.2)},
        "Корги": {"value": 9.36, "sd": 0.27},
        "Лабрадор ретривер": {"value": 10.8, "sd": 0.6},
        "Лхаса Апсо": {"value": 9.6, "sd": 0.8},
        "Мальтезе": {"value": 9.53, "sd": 0.46},
        "Миниатюрная австралийская овчарка": {"range": (9.4, 11.5)},
        "Мопс": {"value": 10.7, "sd": 0.9},
        "Немецкая овчарка": {"value": 9.7, "sd": 0.7},
    ...
    "Экзоты": {
        ...
        "Хорёк (самцы)": {"value": 5.41, "sd": 0.25},
        "Хорёк (самки)": {"value": 5.27, "sd": 0.23},
    }
}
